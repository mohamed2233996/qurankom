    ...
    return (
        <div className='py-24'>
            <div className="container m-auto">
                {/* تواصل معنا */}
                <h1 className="text-3xl font-bold text-center mb-4">تواصل معنا</h1>
                <p className="text-lg text-gray-400 text-center">
                    ابقا علي اتصال بنا
                </p>
                <div className="mt-8">
                    <h2>للتواصل معنا يمكنك استخدام الخيارات التالية:</h2>
                    <div className="flex flex-col gap-4 mt-4">
                        <div className="flex items-center gap-2">
                            ...
                            <a target='_blank' href="tel:01025402633" className='text-lg font-bold'>+20 01025402633</a>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className='p-2 rounded-full border border-gray-400'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={28} height={28} fill={"none"}>
                            ...
                            <a target='_blank' href='mailto:medomano771@gmail.com' className='text-lg font-bold'>medomano771@gmail.com</a>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className='p-2 rounded-full border border-gray-400'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={28} height={28} fill={"none"}>
                            ...
                            <a target='_blank' href='https://wa.me/01091778151' className='text-lg font-bold'>+20 01091778151</a>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className='p-2 rounded-full border border-gray-400'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={28} height={28} fill={"none"}>
                            ...
                            <a target='_blank' href='https://www.linkedin.com/in/mohamed-gamal-1152992a4/' className='text-lg font-bold'>+20 01091778151</a>
                        </div>
                    </div>
                </div>
            </div>
